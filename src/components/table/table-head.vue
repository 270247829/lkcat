                    ...
                    <div :class="cellClasses(column)">
                        ...
                        <template v-else>
                            ...
                            <span :class="[prefixCls + '-sort']" v-if="column.sortable">
                                <i class="lkui-icon lkui-icon-arrow-up-b" :class="{on: getColumn(rowIndex, index)._sortType === 'asc'}" @click="handleSort(getColumn(rowIndex, index)._index, 'asc')"></i>
                                <i class="lkui-icon lkui-icon-arrow-down-b" :class="{on: getColumn(rowIndex, index)._sortType === 'desc'}" @click="handleSort(getColumn(rowIndex, index)._index, 'desc')"></i>
                            </span>
                            <Poptip
                                v-if="isPopperShow(column)"
                                v-model="getColumn(rowIndex, index)._filterVisible"
                                placement="bottom"
                                popper-class="lkui-table-popper"
                                transfer
                                @on-popper-hide="handleFilterHide(getColumn(rowIndex, index)._index)">
                                <span :class="[prefixCls + '-filter']">
                                    <i class="lkui-icon lkui-icon-funnel" :class="{on: getColumn(rowIndex, index)._isFiltered}"></i>
                                </span>
