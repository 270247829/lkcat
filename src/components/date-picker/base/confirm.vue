<template>
    <div :class="[prefixCls + '-confirm']">
        ...
        <Button size="small" type="text" @click.native="handleClear">{{ t('i.datepicker.clear') }}</Button>
        <Button size="small" type="primary" @click.native="handleSuccess">{{ t('i.datepicker.ok') }}</Button>
    </div>
</template>
<script>
