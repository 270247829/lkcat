<template>
    <div :class="classes" v-clickoutside="handleClose">
        <div ref="reference" @click="toggleVisible" :class="wrapClasses">
            ...
            <i class="lkui-icon lkui-icon-arrow-down-b lkui-input-icon lkui-input-icon-normal"></i>
            <div :class="inputClasses">
                <div :class="[prefixCls + '-color']">
                    <div :class="[prefixCls + '-color-empty']" v-show="value === '' && !visible">
                        <i class="lkui-icon lkui-icon-ios-close-empty"></i>
                    </div>
        ...
        <transition :name="transition">
            <Drop
                ...
                class-name="lkui-transfer-no-max-height"
                :placement="placement"
                ref="drop"
...
<script>
    ...
    const prefixCls = 'lkui-color-picker';
    const inputPrefixCls = 'lkui-input';
