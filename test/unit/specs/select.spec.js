...
describe('Select.vue', () => {
  ...
  describe('Props tests', () => {
    it('should create a Select component with passed placeholder', done => {
      ...
      vm.$nextTick(() => {
        const placeholderSpan = vm.$el.querySelector('.lkui-select-placeholder');
    ...
    it('should create a Select component and take a pre-selected value', done => {
      ...
      vm.$nextTick(() => {
        const selectedValueSpan = vm.$el.querySelector('.lkui-select-selected-value');
    ...
    it('should display normal characters in input when in filterable mode', done => {
      ...
      vm.$nextTick(() => {
        const input = vm.$el.querySelector('.lkui-select-input');
    ...
    it('should set different classes for different sizes', done => {
	  ...
	  `);
      vm.$nextTick(() => {
        const [defaultSelect, largeSelect, smallSelect] = [...vm.$el.querySelectorAll('.lkui-select')];
        expect(defaultSelect.className).to.equal('lkui-select lkui-select-single');
        expect(largeSelect.classList.contains('lkui-select-large')).to.equal(true);
        expect(smallSelect.classList.contains('lkui-select-small')).to.equal(true);
        done();
      });
    });
    ...
    it('should set new options', done => {
      ...
      const callback = function() {
        ...
        const renderedOptions = vm.$el.querySelectorAll('.lkui-select-dropdown-list li');
  ...
  describe('Behavior tests', () => {
    it('should create different and independent instances', done => {
      ...
      new Promise(resolve => {
        const condition = function() {
          const optionsA = SelectA.$el.querySelectorAll('.lkui-select-item');
          const optionsB = SelectB.$el.querySelectorAll('.lkui-select-item');
        ...
        .then(() => {
          ...
          const getSelections = component => {
            const tags = component.$el.querySelectorAll('.lkui-select-selection .lkui-tag');
